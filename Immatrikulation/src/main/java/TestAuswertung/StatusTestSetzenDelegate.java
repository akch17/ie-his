...
public class StatusTestSetzenDelegate implements JavaDelegate {

	// Status für Test setzen
	public StatusTestSetzenDelegate() {
	}
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		// Dazu selecten wir einfach alle die nicht Status 6 haben und updaten den wert
		// auf nicht bestanden
